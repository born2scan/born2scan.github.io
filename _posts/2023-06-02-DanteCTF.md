...
![](/assets/img/DanteCTF_2023/AdventurersKnapsack/matrix.png)
...
🏁 _DANTE{kN4ps4ck_w_l0w_d3NS1ty}_{:.spoiler}
...
$$
flag_dec = flag_enc \oplus keystream
$$
...
🏁 _DANTE{Att4cks_t0_p1x3L_Encrypt3d_piCtUrES_511f0c49f8be}_{:.spoiler}
...
The format of these messages matches the _Position Report_ section of the [APRS protocol specs (page 42)](http://www.aprs.org/doc/APRS101./PDF), in particular the "_Lat/Long Position Report Format — without Timestamp"_ message.
...
🏁 _DANTE{FLAG_REPORTING_SYSTEM}_{:.spoiler}
...
🏁 _DANTE{ch3ck_0ut_abmagick}_{:.spoiler}
...
🏁 _DANTE{g1f5_4r3_m4d3_by_bl0ck5}_{:.spoiler}
...
🏁 _DANTE{n3w_w4v35_0ld_5ch00l}_{:.spoiler}
...
🏁 _DANTE{l4b3l5_c4n_m34n_m4ny_7h1ngs}_{:.spoiler}
...
🏁 _DANTE{wh0_h4s_fl4g_ju5t_45k}_{:.spoiler}
...
🏁 _DANTE{wh0_r3m3mb3r5_ch405n3t_4nd_h3s10d}_{:.spoiler}
...
FlagFabber
├── flagfabber-B_Cu.gbl
├── flagfabber-B_Mask.gbs
├── flagfabber-B_Paste.gbp
├── flagfabber-B_Silkscreen.gbo
├── flagfabber-Edge_Cuts.gm1
├── flagfabber-F_Cu.gtl
├── flagfabber-F_Mask.gts
├── flagfabber-F_Paste.gtp
└── flagfabber-F_Silkscreen.gto
```
...
🏁 _DANTE{pcb5_4r3_c00l}_{:.spoiler}
...
🏁 _DANTE{tr33_0rn4m3nt}_{:.spoiler}
...
To pass the second filter there are many solutions, the most simple one is to use exec(input()) to take another (unfiltered) user input that will then be executed. So the final payload is `𝘦𝘹𝘦𝘤(𝘪𝘯𝘱𝘶𝘵())`, followed by something to read the flag. 

🏁 _DANTE{4b4nd0n_all_h0p3_y3_who_3nter}_{:.spoiler}
...
🏁 _DANTE{AHh9HhH0hH_ThAat_RAnsomware_maDe_m3_SaD_FFFFAAABBBBDDDD67}_{:.spoiler}
...
🏁 _DANTE{Y0u_neeD_t0_PAy_attenti0n_t0_whaT_Y0u_t4ke_n0te_f745c37}_{:.spoiler}
...
🏁 _DANTE{Esc4P3_Fr0M_C0nT41n3R_thp4EDdgtf4}_{:.spoiler}
...
🏁 _DANTE{Y0u_should_looK_FoR_Filippo_Argenti_on_Google_a103de9b1}_{:.spoiler}
...
![](/assets/img/DanteCTF_2023/RustySafe/ghidra.png)
...
![](/assets/img/DanteCTF_2023/RustySafe/ghidra2.png)
...
![](/assets/img/DanteCTF_2023/RustySafe/gdb.png)
...
🏁 _DANTE{tRUST_m3_D4nT3_1s_th3_bEsT}_{:.spoiler}
...
🏁 _DANTE{Mayb3_Flask_Is_n0T_That_s3cur3_00FD8124A}_{:.spoiler}
...
🏁 _DANTE{dant3_1s_inj3cting_everyb0dy_aaxxaa}_{:.spoiler}
...
🏁 _DANTE{Y0u_Kn0w_how_t0_bypass_things_in_PhP9Abd7BdCFF}_{:.spoiler}
...
🏁 _DANTE{alwAys_ch3CK_int3griti3s_f0r_XsS_98_AFEE0912}_{:.spoiler}
...
🏁 _DANTE{SqlInj3cti0n_pLus_d3S3r1al1zatI0N_is_br0K3N_99_99_99_AAFFB78312DD}_{:.spoiler}
...
🏁 _DANTE{Yo0_Must_B3_A_R0boTtTtTtTTtTAD6182_0991847}_{:.spoiler}
...
🏁 _DANTE{Rand0m_R3al_C00ki3_000912_24}_{:.spoiler}
