...
One way to solve the problem is to understand how the encoding function works and based on that derive the flag. But in a situation like this my lazy brain can only thinks about one thing: bruteforce.
