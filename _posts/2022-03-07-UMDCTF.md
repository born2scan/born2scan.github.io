...
For this challenge we were given an ELF file, analyzing it with ghidra we can see that first it asks us for an input and then compares it with a secret phrase if the strings are equal the program print the flag as shown in the image below.

![dragon_pit_ghidra](/assets/img/UMDCTF_2022/dragon_pit.png){: .image-full }

After having spent some time reconstructing the phrase with ghidra i decided to switch to gdb with wich we can right away analyze the cmp function and see in clear our secret phrase.
![dragon_pit_gdb](/assets/img/UMDCTF_2022/dragon_pit_gdb.png){: .image-full }

In the first image we can see that the program asks "When should Fred jump into the dragon pit?", looking at the two phrases on the second image we can see that the first one makes more sense then the other one.
Indeed running the program with __wh3nTheDr4gsHPis1048__ gives us the flag.

![dragon_pit_solution](/assets/img/UMDCTF_2022/dragon_pit_sol.png){: .image-full }
![dragon_pit_memo](/assets/img/UMDCTF_2022/dragon_pit_meme.jpg){: .image-full }
...
![first_function](/assets/img/UMDCTF_2022/tiny_first_function.png){: .image-full}
...
![first_part_script](/assets/img/UMDCTF_2022/tiny_first_part_script.png){: .image-full}
...
![second_function](/assets/img/UMDCTF_2022/tiny_second_function.png){: .image-full}
...
![second_part_script](/assets/img/UMDCTF_2022/tiny_second_part_script.png){: .image-full}
